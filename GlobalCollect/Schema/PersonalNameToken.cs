...
namespace GlobalCollect.Schema
{
    public class PersonalNameToken
    {
        ...
        /// <summary>
        /// Surname(s) or last name(s) of the consumer Required for Direct Debit Switzerland (707), except when a token has been included in the request that includes this value.
        /// </summary>
